...
/*
** A hybrid mergesort combined with quicksort and insertion sort. When
** the file size is less than cutoff M2, we use quicksort to sort it.
** If the file size is less than cutoff M1, we use insertion sort.
*/
void merge_sort(item_t *array,int left,int right)
{
